...
export function getEventAuthorityCodec(): FixedSizeCodec<
  EventAuthorityArgs,
  EventAuthority
> {
...
export async function fetchMaybeEventAuthority<
...
export async function fetchAllEventAuthority(
  ...
  const maybeAccounts = await fetchAllMaybeEventAuthority(
    rpc,
    addresses,
    config,
  );
...
export async function fetchAllMaybeEventAuthority(
  ...
  return maybeAccounts.map((maybeAccount) =>
    decodeEventAuthority(maybeAccount),
  );
}
