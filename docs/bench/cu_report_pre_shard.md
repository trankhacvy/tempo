...
> **BASELINE SNAPSHOT** — archived at the start of `feat/sharded-book` (Stage 0). This is the pre-sharding CU profile; compare the post-Stage-A `cu_report.md` against this file.
