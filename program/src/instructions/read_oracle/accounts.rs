...
/// Accounts for the ReadOracle instruction (permissionless).
///
/// # Account Layout
/// 0. `[signer]` cranker
/// 1. `[]` market
...
/// 3. `[]` event_authority
/// 4. `[]` tempo_program
pub struct ReadOracleAccounts<'a> {
...
impl<'a> TryFrom<&'a [AccountView]> for ReadOracleAccounts<'a> {
...
impl<'a> InstructionAccounts<'a> for ReadOracleAccounts<'a> {}
