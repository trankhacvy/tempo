...
impl UpdateMakerQuoteLevels {
  pub fn instruction(&self, args: UpdateMakerQuoteLevelsInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: UpdateMakerQuoteLevelsInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = UpdateMakerQuoteLevelsInstructionData::new().try_to_vec().unwrap();
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = UpdateMakerQuoteLevelsInstructionArgs {
                                                              sequence: self.instruction.sequence.clone().expect("sequence is not set"),
                                                                  ...
                                                                  num_bids: self.instruction.num_bids.clone().expect("num_bids is not set"),
                                                                  num_asks: self.instruction.num_asks.clone().expect("num_asks is not set"),
                                                                  bid_levels: self.instruction.bid_levels.clone().expect("bid_levels is not set"),
                                                                  ask_levels: self.instruction.ask_levels.clone().expect("ask_levels is not set"),
                                    };
