...
impl FinalizeClear {
  pub fn instruction(&self, args: FinalizeClearInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: FinalizeClearInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
/// (Optional) cranker's collateral ledger to receive the crank fee
#[inline(always)]
    pub fn cranker_collateral(&mut self, cranker_collateral: Option<solana_address::Address>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = FinalizeClear {
          ...
          let args = FinalizeClearInstructionArgs {
                                                              clearing_bump: self.clearing_bump.clone().expect("clearing_bump is not set"),
                                    };
...
/// (Optional) cranker's collateral ledger to receive the crank fee
#[inline(always)]
    pub fn cranker_collateral(&mut self, cranker_collateral: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = FinalizeClearInstructionArgs {
                                                              clearing_bump: self.instruction.clearing_bump.clone().expect("clearing_bump is not set"),
                                    };
