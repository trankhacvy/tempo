...
pub const UPDATE_FUNDING_DISCRIMINATOR: u8 = 13;

/// Accounts.
#[derive(Debug)]
pub struct UpdateFunding {
...
impl UpdateFunding {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = UpdateFundingInstructionData::new().try_to_vec().unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
 pub struct UpdateFundingInstructionData {
            discriminator: u8,
      }

impl UpdateFundingInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 13,
                  }
...
impl Default for UpdateFundingInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `UpdateFunding`.
///
/// ### Accounts:
///
                ///   0. `[signer]` cranker
...
pub struct UpdateFundingBuilder {
...
#[inline(always)]
  ...
  /// `update_funding` CPI accounts.
  pub struct UpdateFundingCpiAccounts<'a, 'b> {
                  /// Permissionless caller
...
/// `update_funding` CPI instruction.
pub struct UpdateFundingCpi<'a, 'b> {
...
impl<'a, 'b> UpdateFundingCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: UpdateFundingCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `UpdateFunding` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` cranker
          ...
          ///   4. `[]` tempo_program
#[derive(Clone, Debug)]
pub struct UpdateFundingCpiBuilder<'a, 'b> {
  instruction: Box<UpdateFundingCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateFundingCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(UpdateFundingCpiBuilderInstruction {
      __program: program,
              cranker: None,
              market: None,
              oracle: None,
...
#[inline(always)]
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = UpdateFundingCpi {
...
#[derive(Clone, Debug)]
struct UpdateFundingCpiBuilderInstruction<'a, 'b> {
