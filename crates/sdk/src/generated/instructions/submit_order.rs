...
impl SubmitOrder {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: SubmitOrderInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = SubmitOrderInstructionArgs {
                                                              side: self.instruction.side.clone().expect("side is not set"),
                                                                  ...
                                                                  reduce_only: self.instruction.reduce_only.clone().expect("reduce_only is not set"),
                                    };
