...
pub const APPLY_SET_ORACLE_DISCRIMINATOR: u8 = 39;

/// Accounts.
#[derive(Debug)]
pub struct ApplySetOracle {
...
impl ApplySetOracle {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = ApplySetOracleInstructionData::new().try_to_vec().unwrap();
...
pub struct ApplySetOracleInstructionData {
    discriminator: u8,
}

impl ApplySetOracleInstructionData {
    pub fn new() -> Self {
...
impl Default for ApplySetOracleInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ApplySetOracle`.
///
/// ### Accounts:
///
///   0. `[signer]` cranker
...
pub struct ApplySetOracleBuilder {
...
/// `apply_set_oracle` CPI accounts.
pub struct ApplySetOracleCpiAccounts<'a, 'b> {
    /// Permissionless caller
...
/// `apply_set_oracle` CPI instruction.
pub struct ApplySetOracleCpi<'a, 'b> {
...
impl<'a, 'b> ApplySetOracleCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ApplySetOracleCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ApplySetOracle` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` cranker
...
///   4. `[]` tempo_program
#[derive(Clone, Debug)]
pub struct ApplySetOracleCpiBuilder<'a, 'b> {
    instruction: Box<ApplySetOracleCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ApplySetOracleCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ApplySetOracleCpiBuilderInstruction {
            __program: program,
            cranker: None,
            market: None,
            new_oracle: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = ApplySetOracleCpi {
...
#[derive(Clone, Debug)]
struct ApplySetOracleCpiBuilderInstruction<'a, 'b> {
