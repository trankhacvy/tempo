...
impl ProcessChunk {
  pub fn instruction(&self, args: ProcessChunkInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ProcessChunkInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = ProcessChunkInstructionArgs {
                                                              start_index: self.instruction.start_index.clone().expect("start_index is not set"),
                                                                  max_count: self.instruction.max_count.clone().expect("max_count is not set"),
                                    };
