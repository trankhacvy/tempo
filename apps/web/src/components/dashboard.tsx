...
import { AuctionView } from "@/components/auction-panel";
...
export function Dashboard() {
  ...
  const slotsLeft =
    view && slot !== null ? view.phaseDeadlineSlot - slot : null;
